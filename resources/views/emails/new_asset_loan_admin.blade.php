...
<head>
    ...
    <title>Pengajuan Peminjaman Asset Baru</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <p style="margin: 10px 0 0 0; color: #f0f0f0; font-size: 14px;">
                                Notifikasi Pengajuan Peminjaman Asset Baru
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 30px 20px 30px;">
                            ...
                            <p style="margin: 15px 0 0 0; color: #374151; font-size: 16px; line-height: 1.6;">
                                Ada pengajuan peminjaman asset baru yang perlu ditinjau dan diproses. Berikut adalah detail pengajuan:
                            </p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <table width="100%" cellpadding="8" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #6b7280; font-size: 14px;">Kode Asset</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: #1f2937; font-size: 14px; font-weight: 600;">
                                                    ...
                                                    @endphp
                                                    {{ $conditionLabels[$assetLoan->asset->condition] ?? 'N/A' }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="color: #6b7280; font-size: 14px;">Nomor Telepon</td>
                                                <td style="color: #1f2937; font-size: 14px; font-weight: 600;">{{ $assetLoan->citizen->phone_number ?? 'N/A' }}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="padding-top: 15px; border-top: 1px solid #e5e7eb;"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="color: #1f2937; font-size: 14px; font-weight: 600;">{{ \Carbon\Carbon::parse($assetLoan->created_at)->locale('id')->isoFormat('D MMMM YYYY, HH:mm') }} WIB</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #6b7280; font-size: 14px;">Tanggal Pinjam</td>
                                                <td style="color: #1f2937; font-size: 14px; font-weight: 600;">{{ \Carbon\Carbon::parse($assetLoan->borrowed_at)->locale('id')->isoFormat('D MMMM YYYY') }}</td>
                                            </tr>
                                            <tr>
                                                <td style="color: #6b7280; font-size: 14px;">Tanggal Kembali Diharapkan</td>
                        ...
                        <td style="padding: 0 30px 20px 30px;">
                            <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px 20px; border-radius: 4px;">
                                ...
                                <p style="margin: 10px 0 0 0; color: #b45309; font-size: 14px; line-height: 1.6;">
                                    Silakan segera tinjau dan proses pengajuan peminjaman asset ini. Pemohon sedang menunggu konfirmasi dari admin desa.
                                </p>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 30px 30px 30px;">
                            ...
                            <ul style="margin: 0; padding-left: 20px; color: #4b5563; font-size: 14px; line-height: 1.8;">
                                ...
                                <li>Verifikasi data peminjam dan ketersediaan asset</li>
                                <li>Periksa kondisi asset sebelum menyetujui peminjaman</li>
                    ...
                    <tr>
                        <td style="padding: 30px; text-align: center;">
                            <a href="{{ config('app.url') }}/asset-loans" style="display: inline-block; background-color: #3b82f6; color: white; text-decoration: none; padding: 14px 40px; border-radius: 6px; font-size: 16px; font-weight: 600; box-shadow: 0 2px 4px rgba(59, 130, 246, 0.4);">
