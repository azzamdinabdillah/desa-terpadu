...
export default function ReturnAssetModal({
    ...
    return (
        <div className="fixed inset-0 z-50">
            ...
            {/* Modal */}
            <div className="fixed top-1/2 left-1/2 z-50 w-[90%] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-lg border border-green-200 bg-white p-6 shadow-lg md:w-full">
                ...
                <div className="flex justify-end gap-3">
                    <Button onClick={handleClose} variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50" disabled={isLoading}>
                        Batal
                    </Button>
